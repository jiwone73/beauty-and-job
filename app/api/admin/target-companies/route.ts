...
//   ① 뚜렷한 오피스 사무직 신호 → OFFICE  ② 뚜렷한 매장 시술 신호 → STORE
...
function guessStoreOffice(title: string): "STORE" | "OFFICE" {
  ...
  if (/인허가|regulatory|품질관리|머천다이저|상품기획|브랜드매니저|퍼포먼스마케팅|재무|회계|세무|법무|구매담당|물류|SCM|인사담당|채용담당|경영지원|전략기획|해외영업|수출입|개발자|엔지니어|데이터분석|약무|약사|고객센터|상담사|콜센터|오피스|사무직|디렉터|기획자|마케터|영업|리크루터|헤드헌터|MD채용|재택|자산운용|펀드|운용역|증권|투자|금융|렌탈|설치기사|생산직|제조|영양사/i.test(t)) return "OFFICE";
