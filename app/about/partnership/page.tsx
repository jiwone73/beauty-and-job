        ...
        {done ? (
          ...
          <div className="info-section">
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              <div className="contact-form-row"><label>제목 *</label><input required placeholder="어떤 제휴인지 한 줄로 적어주세요" value={form.subject} onChange={e=>setForm({...form,subject:e.target.value})} /></div>
