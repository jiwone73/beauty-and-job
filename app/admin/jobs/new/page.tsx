          ...
          <div className="admin-form-body">
            ...
            <div className="admin-form-row">
              <label className="admin-form-label">
                {jobGroupType === "매장" ? "매장명 *" : "기업명 *"}
              </label>
              <input className="admin-form-input"
                placeholder={jobGroupType === "매장" ? "예) 네일살롱 강남점" : "기업명을 입력하세요"}
                value={form.company}
            ...
            <div className="admin-form-row-2col">
              <div className="admin-form-row">
                <label className="admin-form-label">
                  {jobGroupType === "매장" ? "급여" : "연봉"}
                </label>
                <input className="admin-form-input"
                  placeholder={jobGroupType === "매장" ? "예) 월 250만원 / 협의" : "예) 4,000~5,000만원"}
                  value={form.salary}
