...
const targetStyle = (t: string) => {
  if (t === "user") return { background: "#f7f7f8", color: "#555" };
  if (t === "company") return { background: "#f7f7f8", color: "#555" };
              ...
              <li key={n.id} style={{ borderBottom: "1px solid #eee", padding: "12px 4px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ flexShrink: 0, fontSize: 13, fontWeight: 700, padding: "2px 8px", borderRadius: 6,
                    background: "#f7f7f8", color: "#555" }}>
                    {TYPE_LABELS[n.type]}
                  </span>
                  {n.is_pinned && <span style={{ flexShrink: 0, fontSize: 12, color: "#555", border: "1px solid #efeff1", borderRadius: 4, padding: "1px 5px" }}>고정</span>}
