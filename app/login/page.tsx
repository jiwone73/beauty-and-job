        ...
        <div className="login-card">
          ...
          {step !== "method" && (
            <button
              ...
              onClick={() => {
                setStep(step === "verify" ? "phone" : "method");
                setError("");
                setCode("");
              }}
            >
            ...
            <div className="login-methods">
              ...
              <button className="login-kakao-btn" onClick={handleKakaoLogin}>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                  <path
                    d="M11 2C6.029 2 2 5.36 2 9.5c0 2.618 1.664 4.916 4.187 6.258L5.2 19.3c-.09.31.225.56.503.39l4.46-2.94A10.6 10.6 0 0011 17c4.971 0 9-3.36 9-7.5S15.971 2 11 2z"
                    fill="#3A1D1D"
                  />
                </svg>
                카카오로 로그인
          ...
          {step === "verify" && (
            <div className="login-form">
              <p className="login-phone-display">
                <strong>{phone}</strong>으로 인증번호를 보냈어요
              </p>
