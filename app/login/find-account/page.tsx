    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex items-center justify-center px-5">
        <div className="w-full max-w-[400px]">
          ...
          {/* 이름 */}
          <div className="mb-3">
            <label className="block text-[13px] md:text-[14px] text-[#6b6b6b] mb-1.5">이름</label>
            <input
              type="text"
              value={name}
          ...
          {/* 휴대폰 */}
          <div className="mb-2">
            <label className="block text-[13px] md:text-[14px] text-[#6b6b6b] mb-1.5">휴대폰번호</label>
            <input
              type="tel"
              inputMode="numeric"
              value={phone}
          ...
          {result && !result.found && (
            <div className="mt-6 p-5 bg-[#f8f8f8] border border-[#e8e8e8] rounded-lg text-center">
              <p className="text-[14px] md:text-[15px] text-[#1a1a1a] font-normal mb-1">일치하는 계정이 없어요</p>
