              ...
              <form onSubmit={handleSearch} onClick={(e) => e.stopPropagation()}>
                ...
                <div className="mt-search-set">
                  ...
                  <p className="mt-type-desc">
                    {jobType === "매장" ? "헤어·바버 · 메이크업 · 네일·속눈썹 · 피부·바디 · 두피·탈모 · 웨딩·이벤트 · 뷰티 리테일 · 샵 운영·상담 · 미용강사 · 의료미용(병원 현장)"
                      : jobType === "본사" ? "뷰티 플랫폼·콘텐츠 · 뷰티 리테일 & 커머스 · 뷰티 제조·OEM·ODM · 교육·아카데미 · HR 서비스 · 의료미용(해외·통역)"
                      : "매장과 본사 공고를 함께 봅니다"}
                  </p>
