...
type ModalType = "career" | "education" | "skill" | "language" | "link" | "experience" | null;
    ...
    <main className="profile-page">
      <header className="profile-header">
        <div className="profile-header-inner">
          ...
          <button className="profile-settings-btn" onClick={() => alert("알림 설정은 다음 업데이트에서 구현됩니다.")} aria-label="설정">
            <Settings size={22} />
          </button>
        </div>
      </header>
      ...
      <div className="profile-summary">
        ...
        <div className="profile-stats">
          {[["0", "지원 완료"], ["0", "관심 공고"], ["0", "관심 브랜드"]].map(([val, label], i) => (
            <>
              {i > 0 && <div key={`div-${i}`} className="profile-stat-divider" />}
      ...
      <div className="profile-content">
        {activeTab === "profile" ? (
          <>
            ...
            <section className="profile-section">
              ...
              <div className="profile-info-card">
                ...
                <InfoRow label="이메일" value="입력하기" isEmpty onClick={() => alert("이메일 입력은 다음 업데이트에서 추가됩니다.")} />
            ...
            <section className="profile-section">
              ...
              <button className="profile-add-card" onClick={() => alert("관심 브랜드 기능은 다음 업데이트에서 구현됩니다.")}>
          ...
          <div className="profile-resume-empty">
            ...
            <button className="profile-resume-create-btn" onClick={() => alert("이력서 만들기는 다음 업데이트에서 구현됩니다.")}>이력서 만들기</button>
          </div>
        )}
      </div>

      <div className="profile-bottom-cta">
        <button className="profile-resume-btn" onClick={() => alert("이력서 만들기는 다음 업데이트에서 구현됩니다.")}>
          현재 프로필로 이력서 만들기
        </button>
      </div>
