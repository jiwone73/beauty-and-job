...
const PRODUCTS = [
  ...
  },
  {
    ...
    tag: "큐레이션 노출",
    tagColor: "#7c3aed",
    summary: "메인 페이지 '뷰티앤잡 Pick' 섹션에 채용공고·브랜드·서비스를 카드 형태로 노출합니다.",
    desc: "편집팀이 직접 선정하는 큐레이션 영역으로, 신뢰도 높은 브랜드 이미지를 전달합니다. 채용공고뿐 아니라 브랜드·서비스 홍보에도 활용 가능합니다.",
    features: [
      "메인 페이지 Pick 섹션 카드 노출 (최대 6개 슬롯)",
      "채용공고 / 브랜드 / 서비스 모두 등록 가능",
      "카드 클릭 시 상세 페이지 이동",
      "뷰티앤잡 편집팀 소개 문구 작성 지원",
    ],
    pricing: [
      { label: "1주 (7일)", price: "100,000원", badge: "" },
      { label: "2주 (14일)", price: "180,000원", badge: "인기" },
      { label: "4주 (30일)", price: "350,000원", badge: "추천" },
    ],
    note: "슬롯 수량 한정 (월 최대 6개). 조기 마감 시 다음 월로 자동 이월됩니다.",
  },
  {
    id: "top",
    emoji: "🔝",
