...
const PRODUCTS = [
  {
    ...
    tag: "최대 노출",
    tagColor: "#e53935",
    summary: "뷰티워크 메인 페이지 상단 풀 배너에 브랜드·서비스를 노출합니다.",
    ...
    pricing: [
      ...
      { label: "14일", price: "350,000원", badge: "" },
      { label: "30일", price: "300,000원", badge: "추천" },
    ],
    note: "광고 소재(이미지)는 고객사가 직접 제작하여 제공합니다.",
  },
  {
    id: "pick",
    emoji: "⭐",
    ...
    tag: "선별 노출",
    tagColor: "#7c3aed",
    summary: "프리미엄 상단공고 중 뷰티워크가 선별한 공고를 메인 페이지 'Pick' 섹션에 노출합니다.",
    desc: "프리미엄 상단공고를 운영하는 광고주 중에서, 뷰티워크가 신뢰도와 공고 완성도를 기준으로 선별해 메인 'Pick' 섹션에 추가 노출합니다. 별도 신청 상품이 아닌, 프리미엄 광고주에게 제공되는 선별 노출 혜택입니다.",
    features: [
    ...
    pricing: [
      ...
      { label: "30일", price: "200,000원", badge: "추천" },
    ],
    note: "Pick은 프리미엄 상단공고 운영 시 선별을 통해 노출되는 혜택입니다. 노출 여부 및 기간은 뷰티워크가 결정합니다.",
  },
  {
    id: "top",
    emoji: "🔝",
...
const FAQS = [
  ...
  { q: "광고 소재는 직접 만들어야 하나요?", a: "네, 광고 소재(이미지)는 고객사가 직접 제작하여 제공해 주셔야 합니다." },
    ...
    <div className="ads-page">
      ...
      <section className="ads-hero">
        ...
        <p className="ads-hero-desc">
          뷰티워크의 광고 상품으로 채용공고·브랜드·서비스를<br />
