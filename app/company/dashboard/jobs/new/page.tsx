      ...
      <div className="admin-form-grid">
        ...
        <div className="company-card" style={{overflow:"visible"}}>
          ...
          <div className="admin-form-body">
            ...
            <div className="admin-form-row-2col">
              <div className="admin-form-row">
                <label className="admin-form-label">{jobGroupType === "매장·기술직" ? "급여" : "연봉"}</label>
                <input className="admin-form-input"
                  placeholder={jobGroupType === "매장·기술직" ? "예) 월 250만원" : "예) 4,000~5,000만원"}
        ...
        <div className="company-card" style={{overflow:"visible"}}>
          ...
          <div className="admin-form-body">
            {[
              ...
              { key: "benefits", label: jobGroupType === "매장·기술직" ? "근무조건·복지" : "복리후생", placeholder: "복리후생을 입력하세요" },
