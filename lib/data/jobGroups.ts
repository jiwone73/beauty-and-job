...
export const SEARCH_TAGS: Record<string, string[]> = {
  // 매장운영
  "샵매니저": ["샵매니저", "매니저", "매장관리", "실장", "데스크", "예약", "운영", "shop manager", "점장"],
  "뷰티매니저": ["뷰티매니저", "상담실장", "상담", "코디네이터", "고객관리", "카운셀러", "에스테틱", "피부샵"],
  "데스크·리셉션": ["데스크", "리셉션", "안내", "예약", "카운터", "reception"],
  // 미용강사 — 소분류가 가르치는 분야다. 낱말이 짧아 검색어를 넉넉히 단다.
  "헤어": ["헤어강사", "미용강사", "실기강사", "헤어", "커트", "국가고시", "학원", "아카데미", "강사", "선생님"],
  "메이크업": ["메이크업강사", "미용강사", "실기강사", "메이크업", "학원", "아카데미", "강사", "선생님"],
  "네일": ["네일강사", "미용강사", "실기강사", "네일", "학원", "아카데미", "강사", "선생님"],
  "피부": ["피부강사", "미용강사", "실기강사", "피부", "에스테틱", "학원", "아카데미", "강사", "선생님"],
  "교육": ["교육강사", "교육멘토", "교육실장", "원장", "커리큘럼", "학원", "아카데미", "교육"],
