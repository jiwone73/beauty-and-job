...
export const SEARCH_TAGS: Record<string, string[]> = {
  ...
  "헤어스탭": ["assistant", "헤어스탭", "스탭", "스태프", "스텝", "인턴", "어시", "샴푸", "와인딩", "리셉션", "막내", "수습"],
  // 공고는 '스페아'로도 적는다(실제 외부 공고 3건 중 2건이 그 표기였다).
  "주말·단기 스페어": ["spare", "단기", "스페어", "스페아", "알바", "파트타임", "일당"],
  ...
  "H&B·로드숍 카운터 스탭": ["올리브영", "카운터", "캐셔", "pos", "clerk", "h&b", "로드숍"],
