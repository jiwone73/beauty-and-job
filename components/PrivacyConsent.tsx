  ...
  return (
    <div style={{ marginTop: 8, marginBottom: 16 }}>
      <div style={{
        ...
        <p style={{ margin: "0 0 8px", fontWeight: 600, color: "#555" }}>개인정보 수집 및 이용 동의</p>
        <p style={{ margin: 0 }}>
          · 수집 항목: {items}<br />
      ...
      <label style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10, cursor: "pointer", fontSize: 14, color: "#555" }}>
        <input
          type="checkbox"
          checked={agreed}
