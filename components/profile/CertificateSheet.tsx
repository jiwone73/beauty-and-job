...
const CertificateSheet = forwardRef<HTMLDivElement, {
  ...
  return (
    <div ref={ref} style={{ background: "#fff", padding: c ? 8 : 40 }}>
      <div style={{ border: c ? "1.5px solid #555" : "2px solid #555", padding: c ? "12px 10px" : "34px 32px 30px" }}>
        <p style={{ textAlign: "right", fontSize: c ? 8 : 12, color: "#555", margin: "0 0 4px" }}>문서번호 : {docNo}</p>
        <h1 style={{ fontSize: c ? 17 : 26, fontWeight: 800, textAlign: "center", letterSpacing: c ? 0 : 8, margin: c ? "2px 0 8px" : "8px 0 18px", color: "#555" }}>취업활동 증명서</h1>
