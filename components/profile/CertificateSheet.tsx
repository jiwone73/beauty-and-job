...
const CertificateSheet = forwardRef<HTMLDivElement, {
  ...
  const c = compact;
  return (
    <div ref={ref} style={{ background: "#fff", padding: c ? 10 : 40 }}>
      <div style={{ border: "2px solid #333", padding: c ? "16px 12px" : "34px 32px 30px" }}>
        <p style={{ textAlign: "right", fontSize: c ? 10 : 12, color: "#888", margin: "0 0 4px" }}>문서번호 : {docNo}</p>
        <h1 style={{ fontSize: c ? 20 : 26, fontWeight: 800, textAlign: "center", letterSpacing: c ? 3 : 8, margin: c ? "4px 0 12px" : "8px 0 18px", color: "#1a1a1a" }}>취업활동 증명서</h1>
