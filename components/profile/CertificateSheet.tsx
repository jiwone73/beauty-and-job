  ...
  return (
    <div ref={ref} style={{ background: "#fff", padding: 40 }}>
      <div style={{ border: "2px solid #333", padding: "34px 32px 30px" }}>
        ...
        <h1 style={{ fontSize: 26, fontWeight: 800, textAlign: "center", letterSpacing: 8, margin: "8px 0 4px", color: "#1a1a1a" }}>취업활동 증명서</h1>
        <div style={{ width: 64, height: 3, background: "#5f0080", margin: "0 auto 26px" }} />
        ...
        <div style={{ textAlign: "center", marginTop: 42 }}>
          ...
          <p style={{ fontSize: 12, color: "#999", marginTop: 10 }}>뷰티 채용 플랫폼 뷰티워크 · beautynjob.co.kr</p>
        </div>
      </div>
    </div>
  );
