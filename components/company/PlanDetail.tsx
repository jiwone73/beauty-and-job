  ...
  return (
    <div className="pi">
      ...
      {/* 인재 추천은 프리미엄 전용이다 — 스탠다드는 검색으로 직접 찾고,
          프리미엄은 대시보드가 먼저 찾아 추천해 준다. */}
      {것.인재추천 && (
        <section className="pi-sec">
          <h3 className="pi-st">우리 공고에 맞는 인재 추천</h3>
          <p style={{ fontSize: 14.5, color: "#555", lineHeight: 1.7, margin: "0 0 4px" }}>
            채용공고를 등록하면 직군·지역·경력 등 공고 조건에 맞는 인재를 대시보드에서 추천해
            드립니다. 각 인재의 추천 이유도 함께 표시해 적합한 후보자를 쉽게 확인할 수 있습니다.
          </p>
      ...
      <section className="pi-sec">
        ...
        <ul className="pi-warn">
          ...
          {메인자리 && (
            <li>
              메인 공고 노출은 정해진 칸에서 {메인롤링 / 1000}초마다 롤링됩니다. 산 곳이 칸 수보다
