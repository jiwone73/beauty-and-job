  ...
  return (
    <div className="co-top">
      <style>{`
        ...
        .co-top-title { font-size: 20px; font-weight: 700; color: #1a1a1a; margin: 0 0 18px; text-align: center; }
        ...
        .co-set-title { font-size: 20px; font-weight: 700; color: #1a1a1a; margin: 0 0 18px; text-align: center; }
