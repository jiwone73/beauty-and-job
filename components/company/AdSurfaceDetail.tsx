...
const 자리표: Record<string, { 그림: string; 이름: string; 상자들: 상자[] }> = {
  ...
  "jobs-banner": {
    ...
    // 2026-09-22 실제 화면을 다시 찍어 갈아 끼웠다 — 예전 캡처는 이 배너가
    // 아직 큰 배너이던 시절 것이라 자리가 실제보다 훨씬 크게 보였다.
    상자들: [{ 위: 15.0, 높이: 8.3, 왼: 19.1, 오: 2.5, 말: "채용공고 페이지 띠 배너 자리" }],
  },
  "jobs-group-banner": {
    그림: "ad-jobs-group-slot", 이름: "채용공고 목록 (직군 선택)",
    // 두 곳을 두른다. 배너만 두르면 이 배너가 **왜** 떴는지가 안 보인다 —
    // 왼쪽에서 그 직군을 고른 사람에게만 뜨는 자리다.
    // 2026-09-22 실제 화면(헤어·바버 선택)을 다시 찍어 갈아 끼웠다 — 예전
    // 캡처는 배너가 아직 큰 배너이던 시절 것이라 자리가 실제보다 컸다.
    상자들: [
      { 위: 15.0, 높이: 8.3, 왼: 19.1, 오: 2.5,  말: "직군별 띠 배너 자리" },
      { 위: 70.9, 높이: 4.7, 왼: 3.5,  오: 83.7, 말: "고른 직군", 옆: true },
    ],
  },
};
