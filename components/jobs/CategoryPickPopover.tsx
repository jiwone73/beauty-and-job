  ...
  return (
    <>
      <style>{`
        ...
        .cp-group { display: block; width: 100%; text-align: left; padding: 9px 10px; background: none; border: none; cursor: pointer; font-size: 13px; color: #666; border-left: 2px solid transparent; }
